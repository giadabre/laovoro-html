  ...
  <div class="header">
    ...
    <div class="Classic-Hoop-Earring-Medium">
        ...
        <div class="main-carousel"  data-flickity='{ "cellAlign": "left", "contain": true   }'>
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
              <img src="baroque-earring1.webp" alt="">
            </div>
          </div>
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
              <img src="baroque-earring2.webp" alt="">
            </div>
          </div>
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
              <img src="baroque-earring3.webp" alt="">
            </div>
          </div>
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
              <img src="baroque-earring4.webp" alt="">
            </div>
          </div>
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
              <img src="baroque-earring5.webp" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="descrizione reveal">
       <h1>Baroque Pearl Hoop Earrings</h1>
       <p class="price_1 remove">$24.50</p>
       <p class="price_2">$49.00</p>
       <h2>description</h2>
       <p>These earrings feature baroque pearls hanging from our Classic Hoop Earrings. 
        Baroque pearls are naturally formed in the mollusk, and their finite beauty is derived from asymmetric silhouettes—making each pearl unique.</p>
        <div class="details">
          <div class="details__title">
            ...
            <div class="details__content">
              <ul>
                ...
                <li>Weight: Approx 2.5g</li>
                <li>Hoop: 20mm diameter, 4mm thick</li>
                <li>Pearl: Approx 15mm x 5mm</li>
                <li>Pearls are removable</li>
              </ul>
            </div>
        </div>
      ...
      <div class="slider">
        <div class="main-carousel"  data-flickity='{ "cellAlign": "left", "contain": true   }'>
          ...
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
              <img src="baroque-earring3.jpg" alt="">
            </div>
          </div>
          <div class="carousel-cell">
            <div class="carousel-cell__content zoom">
  ...
  <script>
    $( document ).ready(function() {
        ...
        nav.find("ul li").on('click', function() {   
            ...
            if(this_nav.hasClass("single")){
              $(".price_2").addClass("remove")
              $(".price_1").removeClass("remove")
            }
            if(this_nav.hasClass("pair")){
                $(".price_1").addClass("remove")
                $(".price_2").removeClass("remove")
            }
        });
